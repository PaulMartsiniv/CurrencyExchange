...
@Component
public class CurrencyNameSpecification implements SpecificationProvider<CurrencyExchangeRate> {
    private static final String FILTER_KEY = "nameIn";
    private static final String FIELD_NAME = "name";

    @Override
    public Specification<CurrencyExchangeRate> getSpecification(String[] params) {
